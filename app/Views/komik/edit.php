        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('komik/edit/' . $result['komik_id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        <label for="title" class="vol-sm col-form-label">Judul</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="number" class="form-control <?= $validation->hasError('stock') ? 'is-invalid' : '' ?>" id="stock" name="stock" value="<?= old('stock', $result['stock']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
