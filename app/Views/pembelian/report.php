    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <br>
                <!-- Isi Report -->
                <a target="_blank" class="btn btn-primary mb-3" type="button" href="/beli/exportpdf">Export
                    PDF</a>
                ...
                <div class="col">
                        <label class="col-form-label">TOTAL PENGELUARAN PEMBELIAN PRODUK</label>
                        <?= number_to_currency($totalOutcome, 'IDR', 'id_ID', 2) ?>
                </div>
                <!--  -->
            </div>
        </div>
