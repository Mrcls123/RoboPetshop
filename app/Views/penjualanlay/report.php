...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">LAPORAN PENJUALAN LAYANAN</h1>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <!-- Filter -->
                <form action="/juallay/laporan/filter" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-4">
                ...
                <div class="col">
                        <label class="col-form-label">TOTAL PEMASUKAN PENJUALAN LAYANAN</label>
