...
class PenjualanLayanan extends BaseController
{
    private $layanan, $cart, $cust, $penjualan, $penjualanDetail;
    ...
    public function index()
    {
        ...
        $data=[
            'title' => 'Penjualan Layanan',
            'dataLayanan' => $dataLayanan,
            'dataCust' => $dataCust,
        ];
        return view('penjualanlay/list', $data);
    }
           ...
           echo json_encode($response);
            ...
            if($nominal < $totalBayar)
            {
                ...
                foreach($this->cart->contents() as $items){
                    ...
                    $layanan = $this->layanan->where(['id_layanan' => $items['id']])->first();
                    $this->layanan->save([
                        'id_layanan'=> $items['id'],
                        'stok' => $layanan['stok'] - $items['qty'],
                    ]);
    ...
    public function report($tgl_awal=null, $tgl_akhir=null)
    {
        ...
        return view('penjualanlay/report', $data);
    }
    ...
    public function exportPDF()
    {
        ...
        $html = view('penjualanlay/exportPDF', $data);
    ...
    public function exportExcel()
    {
        ...
        foreach ($report as $value){
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('B' . $rows, $value['penjualan_id'])
